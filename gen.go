...
// Mocks generation
//go:generate go run go.uber.org/mock/mockgen@v0.6.0 -source=internal/services/entity.go -destination=internal/services/mocks/entity_mock.go -package=mocks EntityRepository,Transactor
